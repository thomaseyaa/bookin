...
@section('content')
    <!-- HOME-->
    <div class="border-bottom bg-primary-light">
        <div class="container d-flex flex-column" style="min-height: 46rem">
            <div class="row my-auto">
                <div class="col my-auto pt-16 pb-6 pt-lg-8 pb-lg-0">
                    <h1 class="mb-2">Les meilleurs livres et livres audio en illimité</h1>
                    ...
                    <div class="mb-5">
                        <a class="btn rounded-pill btn-white px-4 my-1 mr-2" href=""><i class="fab fa-google-play mr-2 small"></i>Google Play</a>
                        <a class="btn rounded-pill btn-white px-4 my-1" href=""><i class="fab fa-apple mr-2"></i>Apple Store</a>
                    </div>
                    ...
                    <span class="text-muted small">4.5 étoiles basées sur 16.174 notes</span>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-100 mb-5" width="446.555" height="443.975" viewBox="0 0 546.555 543.975" data-aos="fade-left">
    ...
    <div class="row">
        <div class="col text-center pt-8 pb-6">
            <h1 class="display-3 mt-6 mb-3">Abonnement</h1>
        </div>
    </div>
    ...
    <div class="border-top bg-primary-light">
        <div class="container d-flex flex-column" style="min-height: 38rem">
            <div class="row m-auto">
                <div class="col">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-100" width="456.213" height="301.894" viewBox="0 0 656.213 434.243" data-aos="fade-right">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="mb-4">
                            <h3 class="h3 mb-2">Provident similique</h3>
                            <p class="text-muted">Lorem ipsum dolor sit amet cons lectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae labo placeat. Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae labo.</p>
                        </div>
                        <div>
                            <h3 class="h3 mb-2">Perspiciatis minima</h3>
                            <p class="text-muted">Lorem ipsum dolor sit amet cons lectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae labo placeat. Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae labo.</p>
                        </div>
                    </div>
                </div>
